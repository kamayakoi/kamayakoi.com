                        ...
                        {selectedPurchase && (
                            <div className="space-y-4">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                    <div>
                                        <Label htmlFor="newName" className="text-gray-200 text-xs sm:text-sm">
                                            Customer Name
                                        </Label>
                                        <Input
                                            id="newName"
                                    ...
                                    <div>
                                        <Label htmlFor="newPhone" className="text-gray-200 text-xs sm:text-sm">
                                            Phone Number
                                        </Label>
                                        <Input
                                            id="newPhone"
                                ...
                                <div>
                                    <Label htmlFor="newEmail" className="text-gray-200 text-xs sm:text-sm">
                                        Email Address
                                    </Label>
                                    <Input
                                        id="newEmail"
                                ...
                                <div className="bg-card/50 backdrop-blur-sm p-3 rounded-sm border border-slate-700">
                                    ...
                                    <div className="text-xs sm:text-sm space-y-1 text-gray-300">
                                        <div className="truncate">Event: {selectedPurchase.event_title}</div>
                                        <div>

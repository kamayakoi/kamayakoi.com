            ...
            <div className="text-center">
                {status === 'loading' && (
                    <>
                        ...
                        <h1 className="text-2xl font-bold mb-2">Revalidation in progress...</h1>
                        <p className="text-muted-foreground">Refreshing your website content</p>
                    </>
                )}
                ...
                {status === 'error' && (
                    <>
                        ...
                        <p className="text-muted-foreground">Please try again or check the console</p>
                    </>
                )}
            </div>
        </div>

...
export function Footer() {
    ...
    return (
        ...
        <footer className="relative p-4 md:p-6">
            <div className="w-full md:h-[532px] p-4 md:p-11 text-white bg-black dark:bg-[#2A2522] rounded-sm flex flex-col justify-between max-md:gap-8">
                <div className="flex flex-col justify-between md:flex-row relative">
                    <div className="md:basis-3/4 max-md:w-full max-w-[1200px] h-auto">
                        ...
                        <div className="flex gap-2 mb-6 mt-4 md:mt-0 justify-center md:justify-start">
                    ...
                    <div className="max-md:hidden grid grid-cols-3 gap-8 md:gap-6">
                        <div>
                            <div className="mb-6">
                                <h4 className="text-xs font-mono uppercase tracking-widest">EXPLORE</h4>
                            </div>
                            <ul className="space-y-3">
                                <li>
                                    <Link href="/" className="text-white/70 hover:text-white transition-colors text-sm font-light">
                                        Le Rendez Vous Sauvage
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/blog" className="text-white/70 hover:text-white transition-colors text-sm font-light">
                                        Stories
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/shop" className="text-white/70 hover:text-white transition-colors text-sm font-light">
                                        Shop
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/gallery" className="text-white/70 hover:text-white transition-colors text-sm font-light">
                                        Archive
                                    </Link>
                                </li>
                            </ul>
                        ...
                        <div>
                            <div className="mb-6">
                                <h4 className="text-xs font-mono uppercase tracking-widest">CONNECT</h4>
                            </div>
                            <ul className="space-y-3">
                                <li>
                                    <Link href="/artists" className="text-white/70 hover:text-white transition-colors text-sm font-light">
                                        Artists
                                    </Link>
                                </li>
                                <li>
                        ...
                        <div>
                            <div className="mb-6">
                                <h4 className="text-xs font-mono uppercase tracking-widest">LEGAL</h4>
                            </div>
                            <ul className="space-y-3">
                                <li>
                                    <Link href="/privacy" className="text-white/70 hover:text-white transition-colors text-sm font-light">
                                        Privacy
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/terms" className="text-white/70 hover:text-white transition-colors text-sm font-light">
                                        Terms
                                    </Link>
                                </li>
                            </ul>
                ...
                <div className="flex justify-between items-center text-white/70 border-t border-white/20 pt-6">

                ...
                <div className="text-center px-4 md:px-8 max-w-4xl mx-auto">
                    ...
                    {currentItem.type === 'video' && (
                        <button
                            ...
                            className={`mb-8 p-4 rounded-sm border-2 transition-all duration-300 ${showControls ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
                                } ${isPlaying
                ...
                <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex gap-2">
                    {content.map((_, index) => (
                        <button
                            ...
                            className={`w-3 h-1.5 rounded-sm transition-all duration-200 ${index === currentIndex
                                ? 'bg-white scale-110'

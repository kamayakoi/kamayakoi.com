...
// Define proper types for the three.js refs
interface ThreeRefs {
    ...
    <div ref={containerRef} className="hero-container cosmos-style">
      ...
      <div className="hero-content cosmos-content fixed inset-0 flex items-center justify-center z-20 pointer-events-none">
        <div className="text-center px-4">
          ...
          <div
            ref={subtitleRef}
            className={`hero-subtitle cosmos-subtitle text-xl sm:text-2xl md:text-3xl lg:text-4xl text-white max-w-4xl mx-auto font-medium`}
            style={{
              textShadow: `
      ...
      {/* Invisible scroll sections to create scroll height */}
